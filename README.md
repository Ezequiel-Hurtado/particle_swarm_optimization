...
Particle Swarm Optimization (PSO) is a population-based optimization algorithm inspired by the collective behavior of swarms.  
This implementation is modular and designed for experimentation, allowing easy customization of update rules, objective functions, and constraints.
